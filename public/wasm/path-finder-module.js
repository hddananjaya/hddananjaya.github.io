...
var createPathFinderModule = (() => {
  var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
  
  return (
function(createPathFinderModule) {
  createPathFinderModule = createPathFinderModule || {};
...
var Module = typeof createPathFinderModule != 'undefined' ? createPathFinderModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_calc_walls')) {
        Object.defineProperty(Module['ready'], '_calc_walls', { configurable: true, get: function() { abort('You are getting _calc_walls on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_calc_walls', { configurable: true, set: function() { abort('You are setting _calc_walls on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_randomlySeedWalls')) {
        Object.defineProperty(Module['ready'], '_randomlySeedWalls', { configurable: true, get: function() { abort('You are getting _randomlySeedWalls on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_randomlySeedWalls', { configurable: true, set: function() { abort('You are setting _randomlySeedWalls on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_initializeDistanceMap')) {
        Object.defineProperty(Module['ready'], '_initializeDistanceMap', { configurable: true, get: function() { abort('You are getting _initializeDistanceMap on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_initializeDistanceMap', { configurable: true, set: function() { abort('You are setting _initializeDistanceMap on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_findShortestPath')) {
        Object.defineProperty(Module['ready'], '_findShortestPath', { configurable: true, get: function() { abort('You are getting _findShortestPath on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_findShortestPath', { configurable: true, set: function() { abort('You are setting _findShortestPath on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'path-finder-module.wasm';
...
/** @type {function(...*):?} */
var _calc_walls = Module["_calc_walls"] = createExportWrapper("calc_walls");

/** @type {function(...*):?} */
var _randomlySeedWalls = Module["_randomlySeedWalls"] = createExportWrapper("randomlySeedWalls");

/** @type {function(...*):?} */
var _initializeDistanceMap = Module["_initializeDistanceMap"] = createExportWrapper("initializeDistanceMap");

/** @type {function(...*):?} */
var _findShortestPath = Module["_findShortestPath"] = createExportWrapper("findShortestPath");
...
run();
  ...
  return createPathFinderModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = createPathFinderModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return createPathFinderModule; });
else if (typeof exports === 'object')
  exports["createPathFinderModule"] = createPathFinderModule;
